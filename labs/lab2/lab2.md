...
- не обязательно использовать fork
- не обязательно писать под Linux
- замерять результаты работы программы ОБЯЗАТЕЛЬНО на вашей хостовой ОС (не на виртуальной машине)
